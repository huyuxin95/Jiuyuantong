...
import com.jju.yuxin.xiaoyuantong.baidu.BusLineOverlay;
 ...
 * ===============================* 注释专用*=====================================
 *
 * Packname  baidumapsdk.demo.search
 * ClassName  BusLineSearchDemo
 * Describe : 此demo用来展示如何进行公交线路详情检索，
 *          并使用RouteOverlay在地图上绘制 同时展示如何浏览路线节点并弹出泡泡
 * History:
 *
 * ==============================================================================
 */
public class BusLineSearchDemo extends FragmentActivity implements
    ...
    public boolean onKeyDown(int keyCode, KeyEvent event) {
        if (keyCode == KeyEvent.KEYCODE_BACK) {
            startActivity(new Intent(BusLineSearchDemo.this, ChuxingActivity.class));
            finish();
        }
